...
ALTER TABLE cdm5.visit_cost ADD CONSTRAINT xpk_visit_cost PRIMARY KEY ( visit_cost_id ) ;

ALTER TABLE cdm5.procedure_cost ADD CONSTRAINT xpk_procedure_cost PRIMARY KEY ( procedure_cost_id ) ;

ALTER TABLE cdm5.drug_cost ADD CONSTRAINT xpk_drug_cost PRIMARY KEY ( drug_cost_id ) ;

ALTER TABLE cdm5.device_cost ADD CONSTRAINT xpk_device_cost PRIMARY KEY ( device_cost_id ) ;
...
ALTER TABLE cdm5.concept ADD CONSTRAINT fpk_concept_domain FOREIGN KEY (domain_id)  REFERENCES cdm5.domain (domain_id);

ALTER TABLE cdm5.concept ADD CONSTRAINT fpk_concept_class FOREIGN KEY (concept_class_id)  REFERENCES cdm5.concept_class (concept_class_id);

ALTER TABLE cdm5.concept ADD CONSTRAINT fpk_concept_vocabulary FOREIGN KEY (vocabulary_id)  REFERENCES cdm5.vocabulary (vocabulary_id);

ALTER TABLE cdm5.vocabulary ADD CONSTRAINT fpk_vocabulary_concept FOREIGN KEY (vocabulary_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.domain ADD CONSTRAINT fpk_domain_concept FOREIGN KEY (domain_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.concept_class ADD CONSTRAINT fpk_concept_class_concept FOREIGN KEY (concept_class_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.concept_relationship ADD CONSTRAINT fpk_concept_relationship_c_1 FOREIGN KEY (concept_id_1)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.concept_relationship ADD CONSTRAINT fpk_concept_relationship_c_2 FOREIGN KEY (concept_id_2)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.concept_relationship ADD CONSTRAINT fpk_concept_relationship_id FOREIGN KEY (relationship_id)  REFERENCES cdm5.relationship (relationship_id);

ALTER TABLE cdm5.relationship ADD CONSTRAINT fpk_relationship_concept FOREIGN KEY (relationship_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.relationship ADD CONSTRAINT fpk_relationship_reverse FOREIGN KEY (reverse_relationship_id)  REFERENCES cdm5.relationship (relationship_id);

ALTER TABLE cdm5.concept_synonym ADD CONSTRAINT fpk_concept_synonym_concept FOREIGN KEY (concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.concept_ancestor ADD CONSTRAINT fpk_concept_ancestor_concept_1 FOREIGN KEY (ancestor_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.concept_ancestor ADD CONSTRAINT fpk_concept_ancestor_concept_2 FOREIGN KEY (descendant_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.source_to_concept_map ADD CONSTRAINT fpk_source_to_concept_map_v_1 FOREIGN KEY (source_vocabulary_id)  REFERENCES cdm5.vocabulary (vocabulary_id);

ALTER TABLE cdm5.source_to_concept_map ADD CONSTRAINT fpk_source_to_concept_map_v_2 FOREIGN KEY (target_vocabulary_id)  REFERENCES cdm5.vocabulary (vocabulary_id);

ALTER TABLE cdm5.source_to_concept_map ADD CONSTRAINT fpk_source_to_concept_map_c_1 FOREIGN KEY (target_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.drug_strength ADD CONSTRAINT fpk_drug_strength_concept_1 FOREIGN KEY (drug_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.drug_strength ADD CONSTRAINT fpk_drug_strength_concept_2 FOREIGN KEY (ingredient_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.drug_strength ADD CONSTRAINT fpk_drug_strength_unit_1 FOREIGN KEY (amount_unit_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.drug_strength ADD CONSTRAINT fpk_drug_strength_unit_2 FOREIGN KEY (numerator_unit_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.drug_strength ADD CONSTRAINT fpk_drug_strength_unit_3 FOREIGN KEY (denominator_unit_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.cohort_definition ADD CONSTRAINT fpk_cohort_definition_concept FOREIGN KEY (definition_type_concept_id)  REFERENCES cdm5.concept (concept_id);
...
ALTER TABLE cdm5.drug_exposure ADD CONSTRAINT fpk_drug_dose_unit_concept FOREIGN KEY (dose_unit_concept_id)  REFERENCES cdm5.concept (concept_id);
...
ALTER TABLE cdm5.visit_cost ADD CONSTRAINT fpk_visit_cost_id FOREIGN KEY (visit_occurrence_id)  REFERENCES cdm5.visit_occurrence (visit_occurrence_id);

ALTER TABLE cdm5.visit_cost ADD CONSTRAINT fpk_visit_cost_currency FOREIGN KEY (currency_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.visit_cost ADD CONSTRAINT fpk_visit_cost_period FOREIGN KEY (payer_plan_period_id)  REFERENCES cdm5.payer_plan_period (payer_plan_period_id);


ALTER TABLE cdm5.procedure_cost ADD CONSTRAINT fpk_procedure_cost_id FOREIGN KEY (procedure_occurrence_id)  REFERENCES cdm5.procedure_occurrence (procedure_occurrence_id);

ALTER TABLE cdm5.procedure_cost ADD CONSTRAINT fpk_procedure_cost_currency FOREIGN KEY (currency_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.procedure_cost ADD CONSTRAINT fpk_procedure_cost_period FOREIGN KEY (payer_plan_period_id)  REFERENCES cdm5.payer_plan_period (payer_plan_period_id);

ALTER TABLE cdm5.procedure_cost ADD CONSTRAINT fpk_procedure_cost_revenue FOREIGN KEY (revenue_code_concept_id)  REFERENCES cdm5.concept (concept_id);


ALTER TABLE cdm5.drug_cost ADD CONSTRAINT fpk_drug_cost_id FOREIGN KEY (drug_exposure_id)  REFERENCES cdm5.drug_exposure (drug_exposure_id);

ALTER TABLE cdm5.drug_cost ADD CONSTRAINT fpk_drug_cost_currency FOREIGN KEY (currency_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.drug_cost ADD CONSTRAINT fpk_drug_cost_period FOREIGN KEY (payer_plan_period_id)  REFERENCES cdm5.payer_plan_period (payer_plan_period_id);


ALTER TABLE cdm5.device_cost ADD CONSTRAINT fpk_device_cost_id FOREIGN KEY (device_exposure_id)  REFERENCES cdm5.device_exposure (device_exposure_id);

ALTER TABLE cdm5.device_cost ADD CONSTRAINT fpk_device_cost_currency FOREIGN KEY (currency_concept_id)  REFERENCES cdm5.concept (concept_id);

ALTER TABLE cdm5.device_cost ADD CONSTRAINT fpk_device_cost_period FOREIGN KEY (payer_plan_period_id)  REFERENCES cdm5.payer_plan_period (payer_plan_period_id);
